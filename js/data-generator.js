(function(w, undefined) {
  ...
  extraCols = extraCols || 0;
      ...
      row += '<td data-value="1"><img title="active" src="active.png" id="toggle" /></td>';
      ...
      row += '<td data-value="1"><img title="active" src="disabled.png" id="toggle" /></td>';
      
      row += '</tr>';
      row += '<td>' + firstNames[2] + '</td>';
      row += '<td>' + lastNames[2] + '</td>';
      row += '<td data-value="1"><img title="active" src="active.png" /></td>';
      ...
      row += '<td data-value="1"><img title="active" src="suspended.png" /></td>';
